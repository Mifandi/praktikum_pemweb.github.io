...
if (isset($_POST['edit'])) {
    ...
    if ($_FILES["gambar"]["size"] > 0) {
        ...
        move_uploaded_file($tempName, "images/" . $img2);
        $result = mysqli_query($conn, "UPDATE resep SET nama_resep = '$judul', kategori = '$kategori', bahan = '$bahan', instruksi = '$instruksi', gambar = '$img2' WHERE id = '$id'");
